...
DATA(insert (   3013  cidr_ops                        PGNSP PGUID 3021  650 t 0 ));
DATA(insert (   3013  date_ops                        PGNSP PGUID 3037 1082 t 0 ));
DATA(insert (   3013  float4_ops                      PGNSP PGUID 3023  700 t 0 ));
DATA(insert (   3013  float8_ops                      PGNSP PGUID 3023  701 t 0 ));
DATA(insert (   3013  inet_ops                        PGNSP PGUID 3021  869 t 0 ));
DATA(insert (   3013  int2_ops                        PGNSP PGUID 3026   21 t 0 ));
DATA(insert (   3013  int4_ops                        PGNSP PGUID 3026   23 t 0 ));
DATA(insert (   3013  int8_ops                        PGNSP PGUID 3026   20 t 0 ));
...
DATA(insert (   3013  timestamp_ops           PGNSP PGUID 3037 1114 t 0 ));
